...
day1 = ttk.Label(frame, text='Day 1 ')
day1.grid(padx=40, row=1, column=0, sticky=tk.W)

labels = ['Slept at (24 hour clock): ', 'Woke up at: ', 'Substances used: ', 'Sleep duration (hours): ', 'Quality of sleep (1 to 10): ', 'Level of stress (1 to 10): ']
...
def submit():
    ...
    if a > 0:
        ...
        button2 = tk.Button(f2, text='Stress 30Days', height=2, width=25, command=graph2)
        ...
        button222 = tk.Button(f2, text='melatonin 30Days', height=2, width=25, command=graph222)
        button222.grid(row=8, column=0, sticky=tk.W, padx=15)

        button333 = tk.Button(f2, text='melatonin 90Days', height=2, width=25, command=graph333)
...
add_day = tk.Button(win, text='addDay', command=add_day_fun, height=1, width=8)
