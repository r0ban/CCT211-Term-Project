...
labels=['falling asleep time ', 'getting out of bed ','stress substance ', 'sleep duration ', 'quality ', 'Stress throughout the day ']
...
############### buttons for alcohol ###################################
        ...
        def graph333():
            ...
            plt.title('Sleep hours while stress substance is melatonin durring 90 Days')
            plt.xlabel('Days')
            plt.ylabel("Amount of Hours of Sleep")
            plt.show()
...
button2=tk.Button(win,text='Store Data',command=storeData,height = 1, width = 8)
